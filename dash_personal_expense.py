    ...
    children=[
        ...
        html.Div(
            [
                ...
                html.Div(
                    children=[dcc.Graph(id="month_expense", style={"height": "70vh"})],
        ...
        html.Div(
            [
                html.Div(
                    [
                        html.Label(
                            "Elige Categoria(s)", style={"color": colors["text"]}
                        ),
                        dcc.Dropdown(
                            categorias,
                            "Cuentas",
...
def update_output_div(mes):
    ...
    title = (
        "Gastos para " + datetime.strptime(mes, "%b%Y").strftime("%B %Y").capitalize()
    )
